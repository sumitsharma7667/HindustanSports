...
const ProductForm = () => {
    ...
    return (
      ...
      />
                                ...
                                <div class="col-md-6 custom-file">
                                    <label class="custom-file-label mt-3 p-2" for="customFile" >Product Colors</label>
                                    <input type="text" multiple class="custom-file-input" id="customFile" onChange={(e) => { setcolor(e.target.value) }} />
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-6">
